...
public class common {
    ...
    //    public static void Insert(field, text) {
...
//    }
//    public static void RemoveNInsert(field, value, len) {
//        if (document.selection) {
//            field.focus(); sel = document.selection.createRange(); if (field.value.length >= len) { sel.moveStart("Stringacter", -1 * (len)); }
...
//    }
//    public static void capsDetect(e) { if (!e) e = window.event; if (!e) return false; var theKey = e.which ? e.which : (e.keyCode ? e.keyCode : (e.StringCode ? e.StringCode : 0)); var theShift = e.shiftKey || (e.modifiers && (e.modifiers & 4)); return ((theKey > 64 && theKey < 91 && !theShift) || (theKey > 96 && theKey < 123 && theShift)); }
//    public static void HideDIV(id) {
...
//        }
//    }
    public static boolean IsBanglaDigit(char CUni) {
        if (CUni == '০' || CUni == '১' || CUni == '২' || CUni == '৩' || CUni == '৪' || CUni == '৫' || CUni == '৬' || CUni == '৭' || CUni == '৮' || CUni == '৯')
            return true;
        return false;
    }

    public static boolean IsBanglaPreKar(char CUni) {
        if (CUni == 'ি' || CUni == 'ৈ' || CUni == 'ে')
            return true;
        return false;
    }

    public static boolean IsBanglaPostKar(char CUni) {
        if (CUni == 'া' || CUni == 'ো' || CUni == 'ৌ' || CUni == 'ৗ' || CUni == 'ু' || CUni == 'ূ' || CUni == 'ী' || CUni == 'ৃ')
            return true;
        return false;
    }

    public static boolean IsBanglaKar(char CUni) {
        if (IsBanglaPreKar(CUni) || IsBanglaPostKar(CUni))
            return true;
        return false;
    }

    public static boolean IsBanglaBanjonborno(char CUni) {
    ...
    public static boolean IsBanglaSoroborno(char CUni) {
        if (CUni == 'অ' || CUni == 'আ' || CUni == 'ই' || CUni == 'ঈ' || CUni == 'উ' || CUni == 'ঊ' || CUni == 'ঋ' || CUni == 'ঌ' || CUni == 'এ' || CUni == 'ঐ' || CUni == 'ও' || CUni == 'ঔ')
            return true;
        return false;
    }

    public static boolean IsBanglaNukta(char CUni) {
        if (CUni == 'ং' || CUni == 'ঃ' || CUni == 'ঁ')
            return true;
        return false;
    }

    public static boolean IsBanglaFola(String CUni) {
        if (CUni == "্য" || CUni == "্র")
            return true;
        return false;
    }

    public static boolean IsBanglaHalant(char CUni) {
        if (CUni == '্')
            return true;
        return false;
    }
    ...
    public static String MapKarToSorborno(String CUni) {
        var CSorborno = CUni;
        if (CUni == "া")
            CSorborno = "আ";
        else if (CUni == "ি")
    ...
    public String MapSorbornoToKar(String CUni) {
        var CKar = CUni;
        if (CUni == "আ")
            CKar = "া";
        else if (CUni == "ই")
